...
import {
    ...
    AccordionPanel,
    AccordionIcon, Box,
    Center, Text, Mark, Heading, Divider, useColorModeValue, Badge, Highlight, Tooltip, List, ListItem, ListIcon
} from '@chakra-ui/react'
import {MdWork} from 'react-icons/md'
import {cutString} from "../lib/helpers";
import {works, skills} from '../data/index'
        ...
        <>
            <Box m={4} textAlign={'center'}>
                ...
                <Text fontSize="lg" fontWeight="normal">
                    Je suis un développeur web fullstack, passionné par le développement web et mobile.
                    J'ai commencé à coder en 2018, et depuis je n'ai jamais arrêté.
                </Text>
            </Box>
            <Center minHeight={'100vh'} alignItems={'flex-start'}>
                <Box width={{
                    ...
                    <Accordion allowMultiple={true} defaultIndex={[0]}>
                        ...
                        <Acrd
                            title='Exprériences professionnelles'
                            content={
                                <>
                                    <Text
                                        ...
                                        <List spacing={3}>
                                            {
                                                item.lang && item.lang.map((lang, index) => (
                                                    <ListItem key={index}>
                                                        <ListIcon as={lang.icon} color={useColorModeValue('purple', 'orange')}/>
                                                        {lang.title}
                                                    </ListItem>
                                                ))
                                            }
